            ...
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                 ...
                 <div class="h5 mb-0 font-weight-bold text-gray-800">
                    <a href="pages/produto/listagem.php">Ver Produtos</a>
                  </div>
                </div>
                <div class="col-auto">
                    <i class="bi bi-bag-fill text-gray-300 bi-lg"></i>                
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                 ...
                 <div class="h5 mb-0 font-weight-bold text-gray-800">
                    <a href="pages/cliente/listagem.php">Ver Clientes</a>
                  </div>
                </div>
                <div class="col-auto">
                    <i class="bi bi-people-fill text-gray-300 bi-lg"></i>                
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                 ...
                 <div class="h5 mb-0 font-weight-bold text-gray-800">
                    <a href="pages/vendedor/listagem.php">Ver Vendedores</a>
                  </div>
                </div>
                <div class="col-auto">
                    <i class="bi bi-people-fill text-gray-300 bi-lg"></i>                
            ...
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                 ...
                 <div class="h5 mb-0 font-weight-bold text-gray-800">
                    <a href="pages/categoria/listagem.php">Ver Categorias</a>
                  </div>
                </div>
                <div class="col-auto">
                    <i class="bi bi-people-fill text-gray-300 bi-lg"></i>                
            ...
            <div class="card-body">
              <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                 ...
                 <div class="h5 mb-0 font-weight-bold text-gray-800">
                    <a href="pages/venda/listagem.php">Ver Vendas</a>
                  </div>
                </div>
                <div class="col-auto">
                    <i class="bi bi-people-fill text-gray-300 font-large-2"></i>                
                </div>
              </div>
            </div>
          </div>
