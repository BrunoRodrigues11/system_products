<?php
    ...
    foreach (($resu) as $row){
        $query = "DELETE FROM itens_vendas WHERE numero_venda ='$numero'";
        $resultado = mysqli_query($conn, $query);        
    }
    $query = "DELETE FROM vendas WHERE numero ='$numero'";
    $resultado = mysqli_query($conn, $query);
